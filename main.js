...
function setup() {
  ...
  celing = createSprite(400, 145, 617, 10)
  bottom = createSprite(400, 755, 617, 10)
  left = createSprite(95, 450, 10, 617)
  right = createSprite(705, 450, 10, 617)
...
background(255, 100, 0)
  ...
  if(gamestate === 'menu' || gamestate === 'fade'){
    //Background
    strokeWeight(1)
    ...
    strokeWeight(10)
        fill(255)
        text('The Lazer Named Bob', 400, 200)
    
    //Press any key to continue...
        strokeWeight(5)
        textSize(20)
        text('Press any key to continue...', 400, 400)
    ...
    text('Space to pull', 400, 600)
    text('Shift to rotate', 400, 650)
